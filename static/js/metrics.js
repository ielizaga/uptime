      ...
      function(data) {
        ...
        for (var i in data.metrics.metric_all_stats) {
                    var rowTemplate = '<tr>' +
                                      ...
                                      '<td class="mdl-data-table__cell--non-numeric text-align-right">'+data.metrics.metric_all_stats[i]+'</td>' +
                                      '</tr>';
        ...
        for (var i in data.metrics.metric_owned_stats) {
                    var rowTemplate = '<tr>' +
                                      '<td class="mdl-data-table__cell--non-numeric">'+i+'</td>' +
                                      '<td class="mdl-data-table__cell--non-numeric text-align-right">'+data.metrics.metric_owned_stats[i]+'</td>' +
                                      '</tr>';
        ...
        for (var i in data.metrics.metric_quarter_stats) {
                    var rowTemplate = '<tr>' +
                                      '<td class="mdl-data-table__cell--non-numeric">'+i+'</td>' +
                                      '<td class="mdl-data-table__cell--non-numeric text-align-right">'+data.metrics.metric_quarter_stats[i]+'</td>' +
                                      '</tr>';
        ...
        for (var i in data.metrics.metric_month_stats) {
                    var rowTemplate = '<tr>' +
                                      '<td class="mdl-data-table__cell--non-numeric">'+i+'</td>' +
                                      '<td class="mdl-data-table__cell--non-numeric text-align-right">'+data.metrics.metric_month_stats[i]+'</td>' +
                                      '</tr>';
        ...
        for (var i in data.metrics.metric_week_stats) {
                    var rowTemplate = '<tr>' +
                                      '<td class="mdl-data-table__cell--non-numeric">'+i+'</td>' +
                                      '<td class="mdl-data-table__cell--non-numeric text-align-right">'+data.metrics.metric_week_stats[i]+'</td>' +
                                      '</tr>';
